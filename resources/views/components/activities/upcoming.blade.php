<div class="max-w-md mx-auto bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
    <!-- Header -->
    <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Próximas Actividades</h3>
            </div>
    ...
    <!-- Content -->
    <div id="upcoming-activities" class="p-6">
...
class UpcomingActivities {
    ...
    // También necesitas agregar una función para mostrar notificaciones
